...
- **监控发布模式**：监控 GitHub 仓库的提交记录，自动检测新提交并发布对应的技能
...
- WHEN 系统检测到新提交 THEN 系统应读取新提交的 commit message
- WHEN 系统未检测到新提交 THEN 系统应继续监控

#### REQ-006: 提取技能信息

**描述**：系统应从 commit message 中提取技能名称和版本号。
